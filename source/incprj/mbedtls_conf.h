 ...
 *
 */
//#define MBEDTLS_SSL_DEBUG_ALL    //@@MF
...
#else
#define MBEDTLS_SSL_CACHE_DEFAULT_TIMEOUT        3600 /**< 1 hour  */
#define MBEDTLS_SSL_CACHE_DEFAULT_MAX_ENTRIES       8 /**< Maximum entries in cache */
#endif
