...
/*
 * Modified version from Embedded Artists for the iMX RT1062 Developer’s Kit
 */ 
...
void BOARD_BootClockRUN(void)
{
    ...
    DCDC->REG3 = (DCDC->REG3 & (~DCDC_REG3_TRG_MASK)) | DCDC_REG3_TRG(0x14); /* 0x14=1.3V, 0x12=1.25V, originally 0x13=1.275 */
    ...
    if ((((OCOTP->CFG3) >> 16) & 0x3) == 2) {
        CLOCK_SetMux(kCLOCK_PrePeriphMux, 3); /* 600MHz, for non-IT */
    } else {
        CLOCK_SetMux(kCLOCK_PrePeriphMux, 0); /* 528MHz, for IT */
    }
